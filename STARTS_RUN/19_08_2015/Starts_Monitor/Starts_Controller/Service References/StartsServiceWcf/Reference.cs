...
namespace Starts_Controller.StartsServiceWcf {
    ...
    public interface IAppService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppService/trace_Search", ReplyAction="http://tempuri.org/IAppService/trace_SearchResponse")]
        byte[] trace_Search(string p_object, string p_user, string p_frmdate, string p_todate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppService/Trace_Insert", ReplyAction="http://tempuri.org/IAppService/Trace_InsertResponse")]
    ...
    public partial class AppServiceClient : System.ServiceModel.ClientBase<Starts_Controller.StartsServiceWcf.IAppService>, Starts_Controller.StartsServiceWcf.IAppService {
        ...
        public byte[] trace_Search(string p_object, string p_user, string p_frmdate, string p_todate) {
            return base.Channel.trace_Search(p_object, p_user, p_frmdate, p_todate);
        }
        ...
        public void Trace_Insert(string Trace_Object, string Trace_Procedure, string strvalue, string Trace_User, System.DateTime dateTime) {
            base.Channel.Trace_Insert(Trace_Object, Trace_Procedure, strvalue, Trace_User, dateTime);
        }
